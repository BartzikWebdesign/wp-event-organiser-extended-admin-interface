...
function register_own_menu_page() {
	add_submenu_page('edit.php?post_type=event', __('Reservate Tickets', 'event-organiser-extended-admin-interface'), __('Reservate Tickets', 'event-organiser-extended-admin-interface'), 10, 'reservations', 'reservations');
	add_submenu_page('edit.php?post_type=event', __('Edit Booking Details', 'event-organiser-extended-admin-interface'), __('Edit Booking Details', 'event-organiser-extended-admin-interface'), 10, 'editbooking', 'editbooking');
}
